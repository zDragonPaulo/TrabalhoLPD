...
\title{Manual de Instruções: Trabalho de Lingua de Programação Dinâmicas}
...
Para a correta execução deste trabalho, o ambiente deve garantir os seguintes componentes:
\begin{itemize}
